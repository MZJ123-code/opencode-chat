  ...
  if (sessions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4">
        ...
        >
          <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: 'rgba(0, 240, 255, 0.3)' }}>
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
          </svg>
        </div>
        <p className="text-sm text-center" style={{ color: 'rgba(0, 240, 255, 0.35)' }}>暂无对话</p>
        <p className="text-xs text-center mt-1" style={{ color: 'rgba(0, 240, 255, 0.2)' }}>点击上方按钮开始新对话</p>
      </div>
    )
  }
